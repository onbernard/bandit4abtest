...
#'
#'LINUCB algorithme with rejection sampling method. Exclud any choices which not
...
#'arm and associated iteration \item Updates the results matrix S. }
...
#'\code{\link{ProbaMaxForUCB}} and \code{\link{PlayArm}}. Require
...
#'ucb_rejection_sampling_alloc  <- UCB_rejection_sampling(visitor_reward,
#'alpha = 10)
#'@import tictoc
#'@export
